...
The WHIR verifier in Bitcoin Script, using **no `OP_CAT`** and no other disabled
opcode. It is built on [`poseidon2`](../poseidon2/), Poseidon2 over KoalaBear in
Script, and verifies real Plonky3 proofs end to end:
- the Fiat–Shamir sponge and challenger;
- sumcheck rounds and multilinear evaluation;
- query openings;
...
`tests/end_to_end.rs` runs [Plonky3](https://github.com/Plonky3/Plonky3)'s
...
configuration `tests/budget.rs` derives.
